...
- Version 1 excludes potentially useful supporting objects, including procedure examples, software, groups, mitigations, detection strategies, analytics, data sources, data components, and relationships.
