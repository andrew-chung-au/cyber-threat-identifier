...
> - Pairwise LLM-as-judge evaluation (3.1 vs 3.5) and cross-judge agreement analysis over 226 expert-derived cases are implemented; a final default model choice is deliberately deferred until targeted manual review of disagreement cases is completed.
> - An analyst-facing Streamlit UI, monitoring dashboard, query rewriting, and frozen held-out external benchmark remain in progress.
...
- Implement a Streamlit analyst-facing interface and monitoring dashboard.
- Add analyst feedback capture (e.g. thumbs up/down) and link it to logging/monitoring.
...
├── compose.yaml
│
├── app/                     # Streamlit UI (work in progress)
...
| Document | Purpose |
|---|---|
| [`docs/runbook.md`](docs/runbook.md) | Setup, pipeline commands, verification, rebuilds, benchmarks, answer-generation, LLM-as-judge evaluation, and troubleshooting |
...
| [`docs/decisions.md`](docs/decisions.md) | Stable architecture, corpus, retrieval, and evaluation decisions (e.g. DEC‑017, DEC‑018, DEC‑019) |
